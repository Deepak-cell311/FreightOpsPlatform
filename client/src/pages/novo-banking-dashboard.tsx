...
export default function NovoBankingDashboard() {
  // Fetch real banking data from API
  const { data: bankingData } = useQuery({
    queryKey: ["/api/banking/dashboard"],
    retry: false,
  });
  ...
  const expenseCategories = [
    { name: "Software and Subscriptions", amount: 147.10, percentage: 100, color: "bg-blue-500" },
    { name: "Other", amount: 0, percentage: 0, color: "bg-gray-300" }
  ];
  ...
  const recentInvoices = [
    { id: "#4781", client: "Cargomatic Inc", date: "Oct 02, 2024", amount: 1462.50, status: "Paid" },
    { id: "#4782", client: "Cargomatic Inc", date: "Oct 03, 2024", amount: 2925.00, status: "Pending" },
    { id: "#4783", client: "Cargomatic Inc", date: "Oct 03, 2024", amount: 3072.50, status: "Pending" },
    { id: "#4780", client: "Cargomatic Inc", date: "Oct 04, 2024", amount: 1075.00, status: "Paid" }
  ];
        ...
        <div className="mb-8">
          <div className="bg-white rounded-lg p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4 text-center">
              <div>
                <div className="text-blue-600 font-semibold text-lg">${bankingData?.monthly?.toFixed(2) || '0.00'}</div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      <div className="font-medium text-sm">{bankingData?.earnings || 'No earnings data'}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                <div className="text-2xl font-bold">${reserves?.toFixed(2) || '0.00'}</div>
                <div className="text-sm text-gray-500 mb-4">Savings</div>
              ...
              <div className="space-y-3">
                ...
                <div className="border-t pt-3 mt-3">
                  <div className="flex justify-between items-center font-medium">
                    ...
                    <span>${bankingData?.categoryExpenses || '0.00'}</span>
                  </div>
                </div>
              </div>
            </CardContent>
              ...
              <div className="space-y-3">
                {recentInvoices.map((invoice) => (
                  <div key={invoice.id} className="flex justify-between items-center py-2 border-b border-gray-100 last:border-b-0">
                    <div>
                      <div className="font-medium text-sm">Invoice {invoice.id} | {invoice.client}</div>
                      <div className="text-xs text-gray-500">{invoice.date}</div>
                      <div className="text-xs text-blue-600">{invoice.status}</div>
                    </div>
